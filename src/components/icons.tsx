...
export const MediaIcon = ({ color }: Props) => {
  return (
...
export const GifIcon = ({ color }: Props) => {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" fill={color}>
      <g>
...
export const PollIcon = ({ color }: Props) => {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" fill={color}>
      <g>
...
export const EmojiIcon = ({ color }: Props) => {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" fill={color}>
      <g>
...
export const ScheduleIcon = ({ color }: Props) => {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" fill={color}>
      <g>
...
export const ReplyIcon = ({ color }: Props) => {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" fill={color}>
      <g>
...
export const RetweetIcon = ({ color }: Props) => {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" fill={color}>
      <g>
...
export const LikeIcon = ({ color }: Props) => {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" fill={color}>
      <g>
