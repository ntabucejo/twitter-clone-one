...
const Me = () => {
  return (
    <div className="flex items-center justify-between 2xl:w-60 hover:bg-neutral-200 2xl:px-4 px-3 py-3 rounded-full">
      ...
      <DotsHorizontalIcon className="w-4 h-4 text-neutral-500 2xl:block hidden" />
    </div>
  )
}
